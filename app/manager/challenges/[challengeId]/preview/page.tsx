...
export default function PreviewChallengePageManager() {
        ...
        <div className="bg-card border border-border rounded-lg p-8 space-y-6">
          ...
          <div className="space-y-4 border-b border-border pb-6">
            <div className="flex items-start justify-between">
              <div>
                <h2 className="text-2xl font-bold text-foreground">Two Sum</h2>
                <p className="text-sm text-muted-foreground font-mono mt-1">two-sum</p>
              </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              to target. You may assume each input has exactly one solution, and you cannot use the same element twice.
            </p>
          </div>
...
9`}
                ...
                <div className="border-t border-border pt-3">
                  ...
                  <code className="text-sm text-foreground block whitespace-pre font-mono">0 1</code>
                </div>
              </div>
...
6`}
                ...
                <div className="border-t border-border pt-3">
                  <p className="text-xs text-muted-foreground font-semibold uppercase mb-2">Output:</p>
                  <code className="text-sm text-foreground block whitespace-pre font-mono">1 2</code>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Visibility Notice */}
          <div className="bg-slate-500/10 border border-slate-500/20 rounded-lg p-4 mt-6">
            <p className="text-sm text-slate-400">
              <strong>Note:</strong> This challenge is currently <strong>Private (Contest Only)</strong>. It will only
              be accessible to users inside contests where you have selected it.
            </p>
          </div>
        </div>
